package org.firstinspires.ftc.teamcode.PinkRobot;
...
public class PinkHardware {
    ...
    public void init (HardwareMap ahwMap) {
        ...
        rightB_drive = hwMap.get(DcMotorEx.class, "leftB_drive");
        leftF_drive = hwMap.get(DcMotorEx.class, "leftF_drive");
        leftB_drive = hwMap.get(DcMotorEx.class, "rightB_drive");
...
//        webcam = hwMap.get(WebcamName.class, "webcam");
        ...
        ring_blocker = hwMap.get(Servo.class, "top_gate");
