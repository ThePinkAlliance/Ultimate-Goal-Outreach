...
public class SampleMecanumDrive extends MecanumDrive {
    ...
    public SampleMecanumDrive(HardwareMap hardwareMap) {
        ...
        motors = Arrays.asList(PinkSubsystem.robot.leftF_drive, PinkSubsystem.robot.leftB_drive, PinkSubsystem.robot.rightB_drive, PinkSubsystem.robot.rightF_drive);
        ...
        setLocalizer(new org.firstinspires.ftc.teamcode.drive.StandardTrackingWheelLocalizer(hardwareMap));
    }
    ...
    public void setMotorPowers(double v, double v1, double v2, double v3) {
        PinkSubsystem.robot.leftF_drive.setPower(v);
        PinkSubsystem.robot.leftB_drive.setPower(v1);
        PinkSubsystem.robot.rightB_drive.setPower(v2);
        PinkSubsystem.robot.rightF_drive.setPower(v3);
    }
